...
class _ZoneRemoteDataSource implements ZoneRemoteDataSource {
  ...
  @override
  Future<BaseResponse<ZoneComparisonResponse>> compareZones(
    List<int> zoneIds,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'zoneIds': zoneIds};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<ZoneComparisonResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/zones/compare',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<ZoneComparisonResponse> _value;
    try {
      _value = BaseResponse<ZoneComparisonResponse>.fromJson(
        _result.data!,
        (json) => ZoneComparisonResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
